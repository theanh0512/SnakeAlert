...
public class MainActivity extends Activity implements MainPageFragment
        .OnFragmentInteractionListener, GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onStart() {
        ...
        GetDataTask dataTaskForSnakeKind = new GetDataTask(this,
                "http://www.snakealert.net16.net/query_kind_table.php");
